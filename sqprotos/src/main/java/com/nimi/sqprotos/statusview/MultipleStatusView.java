package com.nimi.sqprotos.statusview;
...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.empt_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.load_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.error_view);
   ...
   /* public final void showEmpty() {
    ...
    public final void showNoNetwork() {
        ...
        if (null == mNoNetworkView) {
            ...
            mNoNetworkRetryView = mNoNetworkView.findViewById(R.id.error_retry_view);
