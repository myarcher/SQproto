...
public class MyRatingBar extends LinearLayout {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        countNum = typedArray.getInt(R.styleable.MyRatingBar_starCount, 5);
        countSelected = typedArray.getInt(R.styleable.MyRatingBar_countSelected, 0);
        canEdit = typedArray.getBoolean(R.styleable.MyRatingBar_canEdit, false);
        differentSize = typedArray.getBoolean(R.styleable.MyRatingBar_differentSize, false);
        widthAndHeight = typedArray.getDimension(
                R.styleable.MyRatingBar_widthAndHeight,
                Units.dp2Px(context, 0));
        dividerWidth = typedArray.getDimension(
                R.styleable.MyRatingBar_dividerWidth,
                Units.dp2Px(context, 0));
        stateResId = typedArray.getResourceId(
                R.styleable.MyRatingBar_stateResId, -1);
        initView();
    }
    ...
    private class MyClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (mOnRatingChangeListener != null) {
                mOnRatingChangeListener.onChange(v,countSelected);
            }
        }
    ...
    public interface OnRatingChangeListener {
         ...
         */
        void onChange(View view, int countSelected);
    }
}
