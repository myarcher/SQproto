package com.nimi.sqprotos.view.verticaltab;
...
public class QTabView extends TabView {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mChecked) {
            setBackground(R.color.sort_tab);
            mTitle.setTextColor(mTabTitle.mColorNormal);
    ...
    public static class TabIcon {
        ...
        public static class Builder {
            ...
            public Builder setIconGravity(int gravity) {
                if (gravity != Gravity.LEFT && gravity != Gravity.RIGHT & gravity != Gravity.TOP & gravity != Gravity.BOTTOM) {
