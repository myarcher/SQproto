...
public class PinEntryEditText extends EditText {
    ...
    protected float mLineStroke = 4; //1dp by default
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ?  Color.parseColor("#131313"): ContextCompat.getColor(context, R.color.pin_normal);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ?  Color.parseColor("#131313") : ContextCompat.getColor(context, R.color.pin_normal);
    ...
    private int getColorForState(int... states) {
        return mColorStates.getColorForState(states, Color.parseColor("#131313"));
    }
